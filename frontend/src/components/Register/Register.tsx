...
const SuccessPopup: React.FC<SuccessPopupProps> = ({ username, accountNumber, onClose }) => {
  ...
  return (
    <div className={styles.popupOverlay}>
      <div className={styles.popupContent}>
        ...
        <h3 className={styles.popupTitle}>Registration Successful!</h3>
        ...
        <div className={styles.userDetails}>
          ...
          <div className={styles.detailRow}>
            ...
            <div className={styles.accountNumberSection}>
              <span className={styles.detailValue}>{accountNumber}</span>
              <button 
        ...
        <p className={styles.popupNote}>
          Please save your account number securely. You will need it to login.
        </p>
...
const Register: React.FC = () => {
  ...
  const [successData, setSuccessData] = useState<{username: string; accountNumber: string} | null>(null);
